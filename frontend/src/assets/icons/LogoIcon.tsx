...
export const LogoIcon = (props : iconsInterface) => {
    // return <svg className={`${iconsVariant[props.size]} text-[#4b6bfb]`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    // </svg>
    return <Brain className={`${iconsVariant[props.size]} text-[#4b6bfb]`}/>
}